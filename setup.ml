...
(* OASIS_START *)
(* DO NOT EDIT (digest: b709a6bd0bdcbd7c6f937e84ef69f360) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "ppx for loop perforation";
          description = None;
          categories = [];
               ...
               pre_command =
                 [
                    (OASISExpr.EBool true,
                      Some
                        (("$ocamlfind", ["install"; "ppperforate"; "META"])))
                 ];
               post_command = [(OASISExpr.EBool true, None)]
            };
          uninstall_custom =
            {
               pre_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("$ocamlfind", ["remove"; "ppperforate"])))
                 ];
               post_command = [(OASISExpr.EBool true, None)]
            };
          clean_custom =
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ppperforate.ml"});
               Executable
                 ({
                     cs_name = "aperf";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "aperf.ml"})
            ];
          plugins = [];
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "K\218l\173k\140\227\174\143\1913\187a\155\140\184";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
